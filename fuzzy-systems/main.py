...
if __name__ == "__main__":
    height_dict = {
        150: [0, 0, 0, 0, 0, 0],              # 0
        155: [0.3, 0.2, 0.3, 0.1, 0.2, 0.2],  # 0.21666666666667
        160: [0.6, 0.4, 0.6, 0.3, 0.4, 0.5],  # 0.46666666666667
        165: [0.6, 0.5, 0.7, 0.5, 0.3, 0.6],  # 0.53333333333333
        170: [1, 0.9, 1, 0.7, 0.5, 1],        # 0.85
        175: [1, 1, 1, 1, 0.9, 1],            # 0.98333333333333
        180: [0.8, 0.6, 0.6, 1, 0.7, 0.5],    # 0.7
        185: [0.5, 0.3, 0.2, 0.4, 0.1, 0.2],  # 0.28333333333333
        190: [0, 0, 0, 0, 0, 0]               # 0
    }
